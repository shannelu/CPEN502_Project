...
plt.title('Reward vs Epoch with Different Parameters')
plt.xlabel('Epoch')
plt.ylabel('Reward')
plt.legend()
plt.show()
...
#     # label_name = file_name.replace('.log', '').replace('winrate_', '')
#     plt.plot(epoch_midpoints, win_rates, label=file_name)

# plt.title('Win Rate vs Epoch with different Epsilon')
# plt.xlabel('Epoch')
# plt.ylabel('Win Rate (%)')
# # plt.grid(True)
# plt.legend()
