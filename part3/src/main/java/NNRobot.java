...
////    );
//
//    NeuralNet nn = new NeuralNet(5,4,1,0.2,0.0, true);
//
//
//    // my state
...
//    static String NNDataFilename = "NN.txt";
//
//
//
//    @Override
...
//                        currentAction = enumAction.values()[getExploratoryMove()];
//                    } else {
//                        double DistanceToCenter = getDistFromCenter(myX,myY,centerX,centerY);
//
//                        currentAction = enumAction.values()[getGreedyMove(
...
//
//        double QValue = getQValue(currentReward,offPolicy);
//        //TODO: check whether nn train implemented correctly
//        nn.train(X, QValue);
//
//        TotalWins++;
//        TotalRound++;
//        saveToLog();
////        LUT.save(getDataFile(NNDataFilename));
//    }
//
//    @Override
...
//        int ActionSize = enumAction.values().length;
//        int res = ran.nextInt(ActionSize);
//        return res;
//    }
//
//    //TODO: double check the parameter is passed in the right value
//    public int getGreedyMove(int myEnergyEnum, int enemyEnergyEnum, int DistanceToEnemyEnum, int DistanceToCenterEnum){
//        double bestQ = -Double.MAX_VALUE;
//        int GreedyAction = -1;
//        int ActionSize = enumAction.values().length;
//
//        for(int i=0; i<ActionSize; i++){
////            double[] X = valueToEnum(myEnergy,enemyEnergy,DistanceToEnemy,DistanceToCenter,i);
//            double[] X = new double[]{myEnergyEnum,enemyEnergyEnum,DistanceToEnemyEnum,DistanceToCenterEnum};
//            //TODO: implement function outputFor in Network
//            double qValue = nn.outputFor(X);
//            if(qValue > bestQ){
//                bestQ = qValue;
//                GreedyAction = i;
//            }
...
//    }
////
////    double[] valueToEnum(int myEnergy, int enemyEnergy, int DistanceToEnemy, int DistanceToCenter, int Action) {
////        double myEnergyIndex = EnergyValueToEnum(myEnergy);
////        double enemyEnergyIndex = EnergyValueToEnum(enemyEnergy);
////        double DistanceToEnemyIndex = DistanceValueToEnum(DistanceToEnemy);
////        double DistanceToCenterIndex = DistanceValueToEnum(DistanceToCenter);
////
////        double[] res = new double[]{myEnergyIndex, enemyEnergyIndex, DistanceToEnemyIndex, DistanceToCenterIndex, Action};
////        return res;
////    }
//
////    double EnergyValueToEnum(int EnergyValue){
////        double EnergyIndex;
////        if(EnergyValue == 0){
////            EnergyIndex = 0;
...
////    }
////
////    double DistanceValueToEnum(int DistanceValue){
